...
$l['recentthreads_can_template'] = "Can Use Recent Threads Template Tool?";
$l['recentthreads_templates_updated'] = "The templates have been updated to the master copy.";
$l['recentthreads_update_templates'] = "Update Templates";
$l['recentthreads_export_templates'] = "Export Templates";
$l['recentthreads_download_templates'] = "Download Templates";
$l['recentthreads_file_doesnt_exist'] = "The file does not exist. Use export templates first to generate it.";
$l['recentthreads_file_downloaded_success'] = "File downloaded successfully.";
$l['recentthreads_main'] = "Main";
$l['recentthreads_export_success'] = "Export successful. You may now download them with the Download Templates Tab";
$l['recentthreads_export_error'] = "Export failure.  JSON encoding failed.";
